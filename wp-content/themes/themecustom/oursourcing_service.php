...
<head>
  ...
  <title>Oursourcing service</title>
    ...
    <section class="w-full relative overflow-hidden">
      ...
      <div
        ...
        <div class="w-1/2 max-md:w-full flex flex-col gap-8">
          <h2 class="font-bold md:text-[56px] text-4xl">Fourier's commitment</h2>
          <p class="text-base">
            Personnel, including Initial Personnel involved in the performance of a Customer’s Work, must ensure that
            the Customer's inspection requirements are met (including but not limited to interviews, resume
            schedule/work product response, references, etc.) and obtain the prior written approval of the client.
          </p>
          <button type="button"
      ...
      <div class="swiper serviceSwiper w-full mt-16 max-md:pb-20">
        <div class="swiper-wrapper">
          <div class="swiper-slide text-primary text-base shadow-lg px-8 py-10 max-md:px-4 max-md:py-6 max-md:max-w-full">
            <img loading="lazy" src="assets/images/message.svg" class="w-10 aspect-square" alt="Icon" />
            <p class="mt-6 text-center max-md:max-w-full">The product has exceeded my expectations. It's incredibly
              easy to use and has improved my daily routine</p>
          </div>
          <div class="swiper-slide text-primary text-base shadow-lg px-8 py-10 max-md:px-4 max-md:py-6 max-md:max-w-full">
            <img loading="lazy" src="assets/images/message.svg" class="w-10 aspect-square" alt="Icon" />
            <p class="mt-6 text-center max-md:max-w-full">We highly appreciate Fourier's expertise and support
              throughout the project. Their domain experts provided valuable consultation, helping us architect
              technology solutions to meet our unique requirements</p>
          </div>
          <div class="swiper-slide text-primary text-base shadow-lg px-8 py-10 max-md:px-4 max-md:py-6 max-md:max-w-full">
            <img loading="lazy" src="assets/images/message.svg" class="w-10 aspect-square" alt="Icon" />
            <p class="mt-6 text-center max-md:max-w-full">I love the creativity of your team. You'v always known
              exactly what I want and make my ideas come true</p>
          </div>
        </div>
