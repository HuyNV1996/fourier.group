...
<body>
  ...
  <main>
            ...
            <div class="flex justify-center items-center leading-6 bg-white text-primary">
              <div class="flex flex-col w-full max-w-[968px] max-md:max-w-full">
                ...
                <p class="mt-6 text-base max-md:max-w-full">
                  At Fourier, we specialize in revolutionizing enterprise operations through customized technology
                  solutions. Our adept team collaborates with clients to innovate strategies, streamline workflows,
                  integrate advanced technologies, and optimize resource management.
                </p>
              </div>
            </div>
          </div>
    ...
    <section class="w-full relative overflow-hidden">
      <img src="https://placehold.co/1440x440" alt="bg"
      ...
      <div
        ...
        <div class="w-1/2 max-md:w-full flex flex-col gap-8">
          <p class="text-base">
            With a focus on innovation and strategic implementation, Fourier empowers organizations to unlock their full
            potential and achieve sustainable growth. <br> Experience the difference with Fourier's transformative
            technology
            consulting services.
          </p>
          <button type="button"
          ...
          <div class="flex gap-20 max-md:flex-col max-md:gap-0 py-20 max-md:py-0">
            <article class="flex flex-col max-md:ml-0 w-full">
              <div class="flex flex-col justify-center self-stretch my-auto max-md:max-w-full">
                ...
                <p
                  ...
                  Adapting the latest technologies and practices, we provide partners
                  with solutions helping businesses stay ahead of competitors, offering
                  cutting-edge products and services that meet current market demands
                </p>
              </div>
            </article>
            <aside class="flex flex-col w-6/12 shrink-0 max-md:ml-0 max-md:w-full">
              <figure
                ...
                <img loading="lazy"
                  src="https://cdn.builder.io/api/v1/image/assets/TEMP/87cec05aab0ca39940caf43dbc6839e34df0df6682f61a2017d1884ad6129c42?apiKey=1e64eec6fea84ac4ac698f954b5985e2&"
                  alt="Illustrative image related to market trends" class="w-full aspect-square max-md:max-w-full" />
              </figure>
            </aside>
          </div>
        </div>
          ...
          <div class="flex flex-row-reverse gap-20 max-md:flex-col max-md:gap-0 py-20 max-md:py-0">
            <article class="flex flex-col max-md:ml-0 w-full">
              <div class="flex flex-col justify-center self-stretch my-auto max-md:max-w-full">
                ...
                <p
                  class="justify-center p-10 mt-12 text-xl font-medium leading-7 border-2 border-lime-600 border-solid text-neutral-800 max-md:px-5 max-md:mt-10 max-md:max-w-full">
                  We assists businesses in optimizing workflows and enhancing performance through the implementation of
                  new technologies and the improvement of existing systems
                </p>
              </div>
            </article>
            <aside class="flex flex-col w-6/12 shrink-0 max-md:ml-0 max-md:w-full">
              <figure
                ...
                <img loading="lazy" src="/assets/images/bg11.jfif" alt="Illustrative image related to market trends"
                  class="w-full aspect-square max-md:max-w-full object-cover" />
              </figure>
            </aside>
          </div>
        </div>
          ...
          <div class="flex gap-20 max-md:flex-col max-md:gap-0 py-20 max-md:py-0">
            ...
            <aside class="flex flex-col w-6/12 shrink-0 max-md:ml-0 max-md:w-full">
              <figure
                ...
                <img loading="lazy" src="/assets/images/bg12.jfif" alt="Illustrative image related to market trends"
                  class="w-full aspect-square max-md:max-w-full object-cover" />
              </figure>
            </aside>
          </div>
